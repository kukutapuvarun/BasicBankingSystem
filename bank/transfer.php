...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
 <a class="navbar-brand" href="#">
   ...
   <!--  <i class="d-inline-block  fa fa-building fa-fw"></i> --><?php echo "Everyone's Bank"; ?>
  </a>
  ...
  <div class="card-body">
      <form method="POST">
          <div class="alert alert-success w-50 mx-auto">
            ...
            <input type="text" name="otherNo" class="form-control " placeholder="Receiver's Account number" required>
            <button type="submit" name="get" class="btn btn-primary btn-bloc btn-sm my-1">Next</button>
          </div>
      </form>
