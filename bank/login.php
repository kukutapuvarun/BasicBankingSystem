...
<h1 class="alert alert-success rounded-0"><?php echo "Everyone's Bank"; ?><small class="float-right text-muted" style="font-size: 12pt;"><kbd>&copy; VarunKumar</kbd></small></h1>
<br>
<?php echo $error ?>
<br>
